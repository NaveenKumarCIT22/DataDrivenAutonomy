...
def run_simulation(genomes, config):
    ...
    while True:
        ...
        # Display Info
        text = generation_font.render("Generation: " + str(current_generation), True, (255,25,0))
        text_rect = text.get_rect()
        text_rect.center = (900, 450)
        screen.blit(text, text_rect)

        text = alive_font.render("Still Alive: " + str(still_alive), True, (255,25,0))
        text_rect = text.get_rect()
    ...
    # Find the best neural network and save it
    best_net = None
    best_fitness = 0
